...
const Pastproject = () => {
  return (
    <section className=' pt-[5px] pb-[5px] pr-[10px] pl-[10px] bg-[#030712] text-[#ffffff] w-[100vw] h-[100vh]  '>
      ...
      {/* Project TOP SECTION */}
        ...
        <Pastprojectcard  projectscreenshot={pr2} projectname="Timbu App"  projectabout="Lorem ipsum dolor 
